import { describe, h, defineComponent, ref, Fragment, Teleport, Suspense, expectError, expectAssignable, resolveComponent } from './index';
...
describe('describeComponent extends Component', () => {
    // functional
    expectAssignable(defineComponent((_props) => { }));
    // typed props
    expectAssignable(defineComponent({}));
    // prop arrays
    expectAssignable(defineComponent({
        props: ['a', 'b']
    }));
