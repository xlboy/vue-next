...
describe('ssr: inject <style vars>', () => {
  test('basic', () => {
    expect(
      ...
      const { ssrRenderAttrs: _ssrRenderAttrs } = require(\\"@xlboy-v3/server-renderer\\")
  ...
  test('passing on to components', () => {
    expect(
      ...
      const { ssrRenderAttrs: _ssrRenderAttrs, ssrRenderComponent: _ssrRenderComponent } = require(\\"@xlboy-v3/server-renderer\\")
  ...
  test('w/ suspense', () => {
    expect(
      ...
      const { ssrRenderAttrs: _ssrRenderAttrs, ssrRenderSuspense: _ssrRenderSuspense } = require(\\"@xlboy-v3/server-renderer\\")
