...
describe('ssr: components', () => {
  test('basic', () => {
    expect(compile(`<foo id="a" :prop="b" />`).code).toMatchInlineSnapshot(`
      ...
      const { ssrRenderComponent: _ssrRenderComponent } = require(\\"@xlboy-v3/server-renderer\\")
  ...
  test('dynamic component', () => {
    expect(compile(`<component is="foo" prop="b" />`).code)
      ...
      const { ssrRenderVNode: _ssrRenderVNode } = require(\\"@xlboy-v3/server-renderer\\")
  ...
  describe('slots', () => {
    ...
    test('explicit default slot', () => {
      expect(compile(`<foo v-slot="{ msg }">{{ msg + outer }}</foo>`).code)
        ...
        const { ssrRenderComponent: _ssrRenderComponent, ssrInterpolate: _ssrInterpolate } = require(\\"@xlboy-v3/server-renderer\\")
    ...
    test('nested transform scoping in vnode branch', () => {
      expect(
        ...
        const { ssrRenderComponent: _ssrRenderComponent, ssrRenderList: _ssrRenderList } = require(\\"@xlboy-v3/server-renderer\\")
    ...
    describe('transition-group', () => {
      test('basic', () => {
        expect(
          ...
          "const { ssrRenderList: _ssrRenderList } = require(\\"@xlboy-v3/server-renderer\\")
